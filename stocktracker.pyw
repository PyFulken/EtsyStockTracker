...
def populate_window(stock_data):
    ...
    return item_amounts , stock_amount_labels

def repopulate_amounts():
    new_stock_data = json_handler.load_data()
...
refresh_button = Button(root, text="Refresh", command=repopulate_amounts)
